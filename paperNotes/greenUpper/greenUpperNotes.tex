...
\pagebreak
\chapter{An upper limit on the frequency of short-period black hole companions to Sun-like stars \cite{greenUpperLimitFrequency2025}}
\hrule
\vspace{.5cm}
\section{Abstract}
\hrule
...
\item Searching through for AFGK-type stars in \gls{ac:TESS}\footnote{I wonder why TESS was picked}. These are the \textit{\textbf{non-accreting}} companion and progenitors of LMXBs
...
\item A very small number (7) \gls{ac:BH-LS} systems have been detected
